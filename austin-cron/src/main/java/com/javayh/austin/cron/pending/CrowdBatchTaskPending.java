package com.javayh.austin.cron.pending;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.core.text.StrPool;
import com.google.common.collect.Lists;
import com.javayh.austin.common.constant.AustinConstant;
import com.javayh.austin.cron.config.CronAsyncThreadPoolConfig;
import com.javayh.austin.cron.constants.PendingConstant;
import com.javayh.austin.cron.vo.CrowdInfoVo;
...
import com.javayh.austin.service.api.service.SendService;
import com.javayh.austin.support.pending.AbstractLazyPending;
import com.javayh.austin.support.pending.PendingParam;
    ...
    public void doHandle(List<CrowdInfoVo> crowdInfoVos) {
        ...
        for (CrowdInfoVo crowdInfoVo : crowdInfoVos) {
            ...
            if (Objects.isNull(paramMap.get(vars))){
                ...
                String newReceiver = StringUtils.join(new String[]{paramMap.get(vars),receiver}, StrPool.COMMA);
